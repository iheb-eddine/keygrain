...
`;
  ...
  // accepted, documented limitation. The browser toolbar popup and the Ctrl+Shift+L
  // (Cmd+Shift+L on mac) "fill_credentials" command are rendered by browser chrome,
