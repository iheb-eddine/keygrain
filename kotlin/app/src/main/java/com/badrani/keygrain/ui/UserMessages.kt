...
object UserMessages {
    ...
    const val NOT_FOUND = "No backup exists for this email. Check the email address or create a backup first."
    const val CONFLICT_ERROR = "Another device updated your backup since you last synced."
    const val DECRYPT_BACKUP_ERROR = "Couldn't decrypt the backup. Make sure you're using the same secret and email you used to create it."
    ...
    fun backupSuccess(count: Int) = "Backup complete \u2014 $count services saved to server."
    fun restoreSuccess(count: Int) = "Restored $count services from backup."
